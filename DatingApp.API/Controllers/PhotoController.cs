...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPhoto(int id)
        {
            ...
            var photoReturn = _mapper.Map<ReturnPhotoDto>(photoFromRepo);

            return Ok(photoReturn);
        }

        [HttpPost]
        public async Task<IActionResult> AddUserPhoto(int userId, [FromForm]NewPhotoDto newPhoto)
        {
            ...
            newPhoto.Url = uploadResult.Url.ToString();
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.IsMain)
                return BadRequest("Photo is already the default.");
            ...
            return BadRequest("Could not set photo as the main photo.");
        }
